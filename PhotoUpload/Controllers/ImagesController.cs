...
namespace PhotoUpload.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Image_Id,image,Image_Name")] Images images, HttpPostedFileBase filelist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Image_Id,image,Image_Name")] Images images)
        {
            if (ModelState.IsValid)
            { 
